      ...
      <Container fluid className="split-layout noto" id="tags">
          ...
          <Col md={8} className="text-section d-flex flex-column justify-content-center" >
            ...
            <p>
              ...
              <li><b>SPORTS</b>: blogposts containing material/things regarding sports and fitness</li>
              </ul>
            </p>
            ...
            <Col md={3} className="d-grid gap-2">
              <Button variant="primary" size="lg" href="/tags/thoughts">Thoughts</Button>
            </Col>
            <Col md={3} className="d-grid gap-2">
              <Button variant="primary" size="lg" href="/tags/sports">Sports</Button>
            </Col>
          </Row>
</div>
