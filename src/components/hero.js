...
const HeroSection = () => {
  return (
    <div>
        ...
        <div className="mask">
          <Container className="d-flex justify-content-center align-items-center h-100">
            <div className="text-white text-center">
              ...
              <Button variant="outline-light" size="lg" href="#!">SEE WHOLE BLOG CATALOG!</Button>
            </div>
          </Container>
        </div>
      </div>
      ...
      <Container fluid className="split-layout noto">
  ...
  <Row className="button-row">
    <Col md={3} className="d-grid gap-2">
      <Button variant="primary" size="lg">Projects</Button>
    </Col>
    <Col md={3} className="d-grid gap-2">
      <Button variant="primary" size="lg">Tech</Button>
    </Col>
    <Col md={3} className="d-grid gap-2">
      <Button variant="primary" size="lg">Personal</Button>
    </Col>
    <Col md={3} className="d-grid gap-2">
      <Button variant="primary" size="lg">Updated</Button>
    </Col>
  </Row>
</div>
