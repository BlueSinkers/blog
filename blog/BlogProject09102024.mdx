---
title: "This Blog and Site"
dateMade: "09-10-2024"
dateEdited: "08-07-2022"
slug: "blog-writeup"
syn: "PROJECT: this is my blog write-up of THIS blog and my site"
tags: ["project", "tech"]
image: "https://dvyvvujm9h0uq.cloudfront.net/com/articles/1516553730-shutterstock_429631015.jpg"
---
# This Blog and Site

This blog along with my main site is a project of mine that I have been working on for over 2 months. It is an entirely responsive website which serves as my portfolio and blog that uses Gatsby for static-site generation. Gatsby is powered on React and serves as a communication-method between MDX (Markdown with JSX) files and React-components. I have used various styles and components inspired from a wide-range of resources which are more thoroughly documented in the [Github page for the website](https://github.com/bluesinkers).
...
1. The photo that I picked of me (in the about-me section) is very characteristic of me. The Cherry Blossoms are “symbolic” of my DMV heritage and the Star Wars Hoodie represents one of my childhood obsessions. My hair being slightly messy and the location being one of my favorite childhood parks also adds to the personal touch.  
2. The photos of me dunking a basketball (albeit they’re somewhat fake – story for a different time) are characteristic of my huge love of basketball and sports in general. I aspire to turn those photos into more gif-like videos where you can see me jumping when hovering over the “see me” button\!  
3. The languages that are switched in the header of the site are all languages I’m interested in and/or are fluent in. The specific languages are English (native), Telugu, Arabic, Spanish (fluent), and French (beginner). The specific phrasings are:
...
1. The photo of me dunking.  
2. The photos of skylines associated with the tags. I think the Dubai skyline is the most aesthetic (although the city has lots of problems with racism and exploitation of South Asian people) so I placed it as the background of the site.  
   1. The background for the Tech tag is a photo of the San Francisco skyline representative of San Francisco’s association with the tech field.  
   2. The background for the Thoughts tag is Chicago because of the history of its involvement with humanities and arts field.  
   3. The background for the Projects tag is the NYC Skyline.  
   4. The background for the Upated tag is Paris.
